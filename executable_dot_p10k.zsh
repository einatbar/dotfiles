# Generated by Powerlevel10k configuration wizard on 2020-02-25 at 14:00 IST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 36282.
# Wizard options: compatible, lean, 2 lines, dotted, no frame, lightest-ornaments,
...
() {
  ...
  # Nvm background color.
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=             # transparent background
  # Custom icon.
  ...
  # Nodenv background color.
  typeset -g POWERLEVEL9K_NODEENV_BACKGROUND=             # transparent background
  ...
  # Node version background color.
  typeset -g POWERLEVEL9K_NODE_VERSION_BACKGROUND=             # transparent background
